...
After a Zoom class ends, everything below happens without any action on your part:

1. **Recording arrives** — Zoom processes the cloud recording (usually 5–15 minutes after class ends), then it's automatically downloaded
...
3. Use the waveform and transcript panel to find the right spots
4. Click **✂ Trim & Publish**
